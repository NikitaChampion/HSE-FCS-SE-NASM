...
[В данной папке](https://github.com/NikitaChampion/HSE-FCS-SE-NASM/tree/master/HW2) представлено выполнение второй домашней работы по работе с NASM.
...
Тесты лежат в папке [tests](./tests) (в папке элементы массива указываются через пробел для лучшей читаемости ввода). [Этот](./tests/convertToRealTest.py) файл конвертирует тест из папки в реальный тест (который можно скопировать и вставить).<br>
...
Программа отработала успешно <br><br>
- **Тест 7**<br>
Введём случайный большой (N = 100) массив из отрицательных, нулевых и положительных элементов (в [-1000, 1000]) (для генерации теста использовалась [эта](./tests/testGenerator.cpp) программа (с соответствующими параметрами); полный тест смотрите [здесь](./tests/test_7.txt)):<br>
<img src="https://github.com/NikitaChampion/HSE-FCS-SE-NASM/blob/master/HW2/pictures/test7.png" alt="" width="700" /> <br>
Программа отработала успешно <br><br>
- **Тест 8**<br>
Введём случайный большой (N = 200) массив из отрицательных, нулевых и положительных элементов (в [-150, 150]) (для генерации теста использовалась [эта](./tests/testGenerator.cpp) программа (с соответствующими параметрами); полный тест смотрите [здесь](./tests/test_8.txt)):<br>
